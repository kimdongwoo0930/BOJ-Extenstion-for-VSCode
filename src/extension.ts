...
export function activate(context: vscode.ExtensionContext) {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('boj-extension-for-vscode.getProblemByNumber', () => {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('boj-extension-for-vscode.checkTestCase', () => {
     ...
     */
    context.subscriptions.push(
        vscode.commands.registerCommand('boj-extension-for-vscode.showProblemWithdoutFile', () => {
     ...
     */
    context.subscriptions.push(
        vscode.commands.registerCommand('boj-extension-for-vscode.showProblem', () => {
     ...
     */
    context.subscriptions.push(
        vscode.commands.registerCommand('boj-extension-for-vscode.gptSolution', () => {
            getSolution(context);
        })
    );
}
